      ...
      <div className={signup ? "container active" : "container"}>
        <div className="user signinBx">
          <div className="imgBx">
            <img
              className="img-fluid"
              src="https://cdn.shopify.com/s/files/1/0179/5829/products/twins-baby-gift-two-bears-in-a-box-boy-boy_grande.jpg?v=1568787305"
              alt=""
            />
          </div>
          <div className="formBx">
            ...
            <button
              className="btn btn-danger rounded-5 btn-block"
        ...
        <div className="user signupBx">
          ...
          <div className="imgBx">
            <img
              src="https://c.shld.net/rpx/i/s/i/mp/10478409/prod_4696610503?hei=499&wid=499&op_sharpen=1"
              alt=""
            />
          </div>
        </div>
